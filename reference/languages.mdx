...
description: 'Complete list of languages and locales supported by Inquira'
---

Inquira supports a wide range of languages and regional variants. Below is a comprehensive list of all supported languages and their corresponding locale codes.
