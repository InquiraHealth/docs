...
We use [Telnyx](https://telnyx.com/) and [CM](https://www.cm.com) to provision and manage phone numbers.
...
For SIP signalling we support UDP/TCP and TLS, whereas for media encryption we support SRTP.
